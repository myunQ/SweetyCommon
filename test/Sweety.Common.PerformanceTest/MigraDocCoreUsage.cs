...
namespace Sweety.Common.PerformanceTest
{
    ...
    {
        public static string ShortText => "Andigna cons nonsectem accummo diamet nis diat.";

        public static string Text => String.Join(' ', Str.ToCharArray()); //"Loboreet autpat, quis adigna conse dipit la consed exeril et utpatetuer autat, voloboreet, consequamet ilit nos aut in henit ullam, sim doloreratis dolobore tat, venim quissequat. Nisci tat laor ametumsan vulla feuisim ing eliquisi tatum autat, velenisit iustionsed tis dunt exerostrud dolore verae.";

        public static string MediumText => Str;//"Incinibh ecte dionsent am, sisl ute magna faccum ing eu feugait ulla consequismod tetum zzrilluptat. Ut velis accum dit la corper inci essequat, venis nisl dolutat. Sandipit esequisit autpat. Magnibh et laortie feugiamcommy nulluptat dolorpero euipis nonum augait wis dit, quamcon sequipit at vel il eui blaorper si tat ipit at nis nullan hent num dunt irit, sum dolendio consendigna consent lan ut illan etue miniam dolenisis nonsenim inim quat, conulla orercinisim vel inci ent illam quat volore veliquam amconsequat. Ut lut incincipit nullaor iriurercip et luptat erat illamco mmoluptat.Ut iriusciduis nonsed do el dolut ea autem il dolore verci blam, quatue el ute facilis cidunt dit alisl ut lut num vercinc illaore del ilisi blandre commodit, quamcon sequipsusto dunt ver illaorperit utpat, velisci lisciniam vent alis nostisi et, quisit, con eu facipit vulputpat.";

        public static string Str => "中国素有“室无瓷不雅观，人无瓷难尊”一说，瓷器（china）对于中国人（China）而言，有着深化骨血般的情感。18世纪初，波兰国王奥古斯都二世同样怀着对瓷器的挚爱，修建了欧洲第一个瓷窑，命名“麦森”。于是，这个为国王打造生活方式的品牌应运而生，阅历了300多年风雨进程的麦森现在已然成为德国甚至全欧洲的第一瓷器品牌，那些高雅的器物被人们赋予“白色黄金”之美誉。令人不可思议的是，这个阅历了11场战役、6个不同政党的品牌，现在仍然秉承着最初的理念，为人们打造精致、高雅的生活方式。";
    }

    public class MigraDocCoreUsage
    {
        public MigraDocCoreUsage()
        {
        ...
        public static Document CreateDocument()
        {
            ...
            document.Info.Title = "你好，MigraDOc";
        ...
        public static void DefineStyles(Document document)
        {
            ...
            style.Font.Name = "Microsoft Yahei";// "Times New Roman";
        ...
        public static void DefineCover(Document document)
        {
            ...
            Image image = section.AddImage(MigraDocCore.DocumentObjectModel.MigraDoc.DocumentObjectModel.Shapes.ImageSource.FromFile(imgFile));
            image.Width = "10cm";
            /**/
        ...
        public static void DefineTables(Document document)
        {
            ...
            DefineTablesDemonstrateAlignment(document);
        ...
        public static void DefineTablesDemonstrateAlignment(Document document)
        {
